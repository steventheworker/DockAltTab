...
void renderUnsupportedWindow(void) {
    ...
    [container addSubview: linkBtn(@"Download scriptable AltTab", @"https://github.com/steventheworker/alt-tab-macos/releases/download/1.94.2/AltTab-scriptable-1.94.2.zip", NSMakeRect(-7, 35, 190, 20))];

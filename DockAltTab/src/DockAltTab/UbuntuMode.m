...
//        [helperLib applescript: [NSString stringWithFormat: @"tell application \"AltTab\" to countWindowsCurrentSpace appBID \"%@\"", tarBID] : ^(NSString* response) {
//            int previewWindowsCount = [response intValue];
...
//                            [helperLib applescriptWithScript: scripts[@"thumbnailPreview"]];
//                            previewTarget = el;
//                        } else {
